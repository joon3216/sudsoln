...
n_only_here = 3
empty_only_here = '.'
for i in range(n_only_here ** 2):
    for j in range(n_only_here ** 2):
        if easy_q[(i, j)] == '':
            easy_q.itemset((i, j), empty_only_here)
        if question2[(i, j)] == "":
            question2.itemset((i, j), empty_only_here)
        if question3[(i, j)] == "":
            question3.itemset((i, j), empty_only_here)
        if question4[(i, j)] == "":
            question4.itemset((i, j), empty_only_here)
        if question7[(i, j)] == "":
            question7.itemset((i, j), empty_only_here)
        if question7_1[(i, j)] == "":
            question7_1.itemset((i, j), empty_only_here)
        if sta410_question[(i, j)] == '':
            sta410_question.itemset((i, j), empty_only_here)
