...
class Sudoku():
    ...
    def copy(self):
        ...
        >>> id(q1_cp) != id(q1)
        True
        >>> id(q1_cp.row(0)) != id(q1.row(0))
        True
        '''
        
        puzzle_copy = np.array([row.copy() for row in self.show])
        return Sudoku(
            puzzle_copy, 
    ...
    def melt(self, include_empty = True):
        ...
        True
        >>> q_small.melt(include_empty = False) == Candidate({
    ...
    def unique_candidates(self, by):
        ...
        >>> q_small.unique_candidates('submatrix') == Candidate({
                               (0, 1): set(),                (0, 3): {'2'}, 
                (1, 0): {'3'},                (1, 2): {'4'}, (1, 3): set(), 
        ...
        True
        >>> q_small.unique_candidates('row') == Candidate({
                               (0, 1): {'4'},                (0, 3): {'2'}, 
        ...
        True
        >>> q_small.unique_candidates('col') == Candidate({
                               (0, 1): set(),                (0, 3): set(),
